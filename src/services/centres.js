...
export default {
    ...
    countingCentres: {
        getAll: function (districtCentreId = "") {
            return new Promise((resolve, reject) => {
                if (districtCentreId === "") {
        ...
        getById: function (countingCentreId = "") {
            return new Promise((resolve, reject) => {
                if (countingCentreId === "") {
                    resolve(undefined)
                } else {
                    for (var i = 0; i < mockCentres.countingCentres.length; i++) {
                        const countingCentre = mockCentres.countingCentres[i];
                        if (countingCentre.countingCentreId === countingCentreId) {
                            return resolve(countingCentre);
                        }
                    }
