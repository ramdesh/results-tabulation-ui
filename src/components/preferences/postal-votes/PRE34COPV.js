...
class PRE34COPV extends Component {
    ...
    handleClickOpen() {
        this.props.history.replace('/PRE34COPV-Entry')
    }
                ...
                <div>
                    <div style={{marginBottom: '3%'}}>
                        <Typography variant="h5" gutterBottom>
                            Presidential Election 2019 - Preferences ( PRE-34-CO ) : Postal Votes
                        </Typography>
